...
export default function CookieNotice(props) {
    return (
        <div
            ...
            className="block absolute z-40 place-self-center left-16 bottom-16 w-1/3 p-4 space-y-4 bg-zinc-100 rounded-3xl outline outline-2 outline-zinc-200 hover:outline-slate-400 outline-offset-0"
        >
            ...
            <div className="flex items-center justify-center w-full">
                <button
                    className="flex-none place-self-center h-9 py-1 px-3 bg-zinc-50 hover:drop-shadow-sm rounded-lg outline outline-2 outline-zinc-200 hover:outline-slate-400 outline-offset-0"
